...
> **There is no real detection, no real clustering, no real OCR, and no real routing.**
> Every number on the screen is generated by a mock. The demo is genuine end-to-end
> plumbing driving fabricated inputs. Do not discover this on day 3.
...
| **whatif** | M2 | **Working.** Hardcoded per-segment penalties for all 26 segments; one row per route including unaffected ones; deterministic | **Stub** — `simulate()` raises. 2 stubs | `services/cloud/intelligence/whatif/impl.py` |
